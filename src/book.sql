...
SELECT BOOKNUM, BOOKTITLE, CATEGORIES, BOOKREADCOUNT, BOOKDEL, GRADE, AUTHOR, ISSUEDATE, BOOKHEADER, RNUM,
PUBLISHER 
FROM(
		SELECT ROW_NUMBER()OVER(ORDER BY CATEGORIES, GRADE DESC) AS RNUM, BOOKNUM, BOOKTITLE, CATEGORIES, BOOKREADCOUNT, BOOKDEL, GRADE, AUTHOR, ISSUEDATE, BOOKHEADER,
		PUBLISHER FROM BOOK
